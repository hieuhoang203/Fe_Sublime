              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                    <Button variant="ghost" size="icon" className="h-8 w-8 text-white/70 hover:text-red-400 hover:bg-red-400/10">
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-12 bg-spotify-light-gray border-0 text-white placeholder:text-spotify-text-gray text-lg h-12 w-full"
              />
            </div>
          </div>
        </div>
