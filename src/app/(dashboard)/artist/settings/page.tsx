      ...
      <div className="pt-12 space-y-6">
        ...
        <div className="space-y-6">
          <h3 className="text-2xl font-semibold text-white flex items-center gap-3">
            <Mic className="h-6 w-6 text-spotify-green" />
            Artist Information
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <FormField label="Artist Name" required error={errors.artistName}>
              {isEditing ? (
                <FormInput
            ...
            <FormField label="Followers">
              <div className="p-4 bg-spotify-light-gray/50 rounded-lg text-white text-lg">
                {formData.followers?.toLocaleString() || "0"} followers
              </div>
            </FormField>

            <FormField label="Total Plays">
              <div className="p-4 bg-spotify-light-gray/50 rounded-lg text-white text-lg">
                {formData.totalPlays?.toLocaleString() || "0"} plays
              </div>
            </FormField>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-spotify-light-gray/50 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-white">Album created</p>
      ...
      <div className="max-w-6xl mx-auto p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            <div className="px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2 text-green-400 bg-green-400/10">
