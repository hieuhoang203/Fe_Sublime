        ...
        <div className="flex-1">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 bg-spotify-light-gray border border-spotify-light-gray text-white placeholder:text-spotify-text-gray text-lg h-12 w-full focus:border-spotify-green focus:ring-2 focus:ring-spotify-green/20"
            />
          </div>
        </div>
      </div>
