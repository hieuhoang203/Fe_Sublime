  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-spotify-black via-spotify-gray to-spotify-black relative overflow-hidden flex flex-col">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-40 right-32 text-spotify-green/15 animate-bounce" style={{ animationDelay: "1s" }}>
          <Music className="h-6 w-6" />
        </div>
        <div className="absolute bottom-32 left-32 text-spotify-green/20 animate-bounce" style={{ animationDelay: "2s" }}>
          <Music className="h-10 w-10" />
        </div>
        <div className="absolute bottom-20 right-20 text-spotify-green/15 animate-bounce" style={{ animationDelay: "0.5s" }}>
      ...
      <div className="relative z-10 p-4 mt-auto">
        <div className="text-center text-spotify-text-gray text-xs">
          <p>
            © 2024 Spotify Clone. Built with Next.js and Tailwind CSS.
          </p>
