...
import { Eye, EyeOff, Mail, Lock, User, Music, ArrowRight, Loader2, Check } from "lucide-react";
              ...
              {formData.password && (
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 text-xs">
                    <span className="text-spotify-text-gray">Password strength:</span>
                    <span
            ...
            <div className="space-y-1">
              <label className="flex items-start space-x-3 cursor-pointer text-sm">
                <input
                  ...
                  className="w-4 h-4 text-spotify-green bg-spotify-light-gray border-spotify-light-gray rounded focus:ring-spotify-green focus:ring-2 mt-0.5"
                />
                <span className="text-spotify-text-gray">
                  I agree to the{" "}
                  <Link href="/terms" className="text-spotify-green hover:text-spotify-green-hover">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link href="/privacy" className="text-spotify-green hover:text-spotify-green-hover">
                    Privacy Policy
                  </Link>
                </span>
              </label>
